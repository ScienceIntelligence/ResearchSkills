...
> 从 Claude Code 迁移 extract-knowhow 到 Codex CLI 的平台差异参考。
...
## 2. Claude Code vs Codex CLI 对照表
...
| Claude Code 工具 | Codex CLI 等价 | 压缩策略建议 |
|---|---|---|
...
- Claude Code：直接复制
- Codex CLI：在头部加 YAML frontmatter 后复制
